      ...
      <div className="inner">
        ...
        <section>
          ...
          <p>
            ...
            Finally, <Link to="#">this is a link</Link>.
          </p>
          <hr />
          <p>
        ...
        <section>
          ...
          <div className="row">
            ...
            <div className="col-6 col-12-medium">
              ...
              <ul className="icons">
                <li>
                  <Link to="#" className="icon style1 fa-twitter">
                    <span className="label">Twitter</span>
                  </Link>
                </li>
                <li>
                  <Link to="#" className="icon style1 fa-facebook">
                    <span className="label">Facebook</span>
                  </Link>
                </li>
                <li>
                  <Link to="#" className="icon style1 fa-instagram">
                    <span className="label">Instagram</span>
                  </Link>
                </li>
                <li>
                  <Link to="#" className="icon style1 fa-github">
              ...
              <ul className="icons">
                ...
                <li>
                  <Link to="#" className="icon style2 fa-github">
                    <span className="label">Github</span>
                  </Link>
                </li>
              </ul>
          ...
          <div className="row">
            ...
            <div className="col-6 col-12-medium">
              ...
              <ul className="actions stacked">
                <li>
                  <Link to="#" className="button primary small fit">
                    Small
                  </Link>
                </li>
                <li>
        ...
        <section>
          ...
          <ul className="actions">
            <li>
              <Link to="#" className="button primary icon fa-download">
                Icon
              </Link>
            </li>
            <li>
              <Link to="#" className="button icon fa-upload">
                Icon
              </Link>
            </li>
            <li>
              <Link to="#" className="button icon fa-save">
                Icon
              </Link>
            </li>
          </ul>
